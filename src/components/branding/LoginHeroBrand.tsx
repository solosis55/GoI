    ...
    >
      <button
        ...
        className={[
          ...
          "focus-visible:ring-2 focus-visible:ring-neutral-500/45 focus-visible:ring-offset-2 focus-visible:ring-offset-black light:focus-visible:ring-zinc-400/50 light:focus-visible:ring-offset-[var(--goi-page-bg)]",
